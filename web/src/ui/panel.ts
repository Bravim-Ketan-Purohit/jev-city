...
type Tab = "inspector" | "metrics" | "log";
...
export class Panel {
  ...
  constructor(
    ...
    this.tabs = { inspector: mk("inspector", "INSPECTOR"), metrics: mk("metrics", "METRICS"), log: mk("log", "LOG") };
    this.body = el("div", { class: "tab-body" });
    root.append(el("div", { class: "tabs" }, [this.tabs.inspector, this.tabs.metrics, this.tabs.log]), this.body);
